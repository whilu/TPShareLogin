...
public class Config {
    ...
    public static final String KEY_OF_API_TYPE = "key_of_api_type";
    ...
    public static final String KEY_OF_QQ_BCR = "qq_broadcast_receiver";
    public static final String KEY_OF_QQ_BCR_ACTION = "qq_broadcast_receiver_action";
